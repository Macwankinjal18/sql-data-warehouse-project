...
========================================================================
Script Purpose:
  This stored procedure loads data into the 'bronze' schema from external CS files.
...
BEGIN
	...
	BEGIN TRY
		...
		PRINT '>> ===========================';
		PRINT '>> Loading Bronze layer is Completed: ' + CAST(DATEDIFF(Second,@start_batchtime, @end_batchtime) AS NVARCHAR) + 'seconds';
		PRINT '>> ===========================';
